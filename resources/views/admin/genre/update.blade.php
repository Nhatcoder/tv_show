                ...
                <div class="col-md-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('genre.update', ['genre' => $genre->id]) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        value="{{ isset($genre->name) ? $genre->name : old('name') }}" name="name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Điền vào trỗ trống ..." readonly
                                        ...
                                        placeholder="slug" value="{{ isset($genre->slug) ? $genre->slug : old('slug') }}"
                                        name="slug">
                                    @error('slug')
                                        <div class="invalid-feedback">
                                            {{ $message }}
